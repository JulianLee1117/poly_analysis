...
14. **All share-count and dollar tilt measures are biased by price asymmetry.** Share-weighted (41.4%) biased DOWN, dollar-weighted (68.4%) biased UP. The old "price-residual" test was algebraically identical to gross share count (S_u >= S_d) — prices cancel entirely, leaving the same downward bias. **Unbiased tests:** (a) Symmetric subset (|VWAP gap| < 5¢, n=701): gross tilt 40.1% vs subset null 46.4%, z=-3.33 — anti-prediction direction, not prediction. (b) Dollar allocation conditional on outcome: actual gap +0.149 vs price-implied gap +0.265, excess gap = -0.116 — bot allocates LESS toward winner than an equal-shares buyer would. (c) Near-equal allocation: mean Up frac 0.4925 (std 0.1963). Conclusion: no directional prediction.
17. **Never compare tilt accuracy to 50%.** In these momentum markets, the cheaper side wins only 16.6% of the time (overall) or 46.4% (symmetric subset). Always compare to the analytical null baseline (cheaper-side win rate), or use the dollar allocation excess gap test (actual vs price-implied conditional on outcome).
...
- **Unbiased tests:**
  - **Symmetric subset** (|VWAP gap| < 5¢, n=701): gross tilt 40.1% vs subset null 46.4%, z=-3.33. Bot does WORSE than null (anti-prediction direction), consistent with equal-dollar buying noise.
  - **Dollar allocation excess gap:** Actual conditional gap +0.149 vs price-implied +0.265, excess = -0.116. Bot allocates LESS toward the winner than equal-shares buying would. Not prediction.
